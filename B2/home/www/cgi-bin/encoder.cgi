...
params=`/usr/sbin/encoder_params $encaddr $encport 2 "enc0.vid_bitrate|enc0.vid_in|enc0.aud_bitrate|enc0.aud_sample_rate|enc0.vid_res|"`
        ...
        <hr size="1">
            ...
            <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    ...
                    <td class="value">
                        <input type="text" name="encaddr" value="$encaddr">
                    </td>
                </tr>
                <tr>
                    <td class="label">
                    ...
                    <td class="value">
                        <input type="radio" name="vidres" value="352x288"$cif>CIF
                        <input type="radio" name="vidres" value="720x576"$d1>D1
